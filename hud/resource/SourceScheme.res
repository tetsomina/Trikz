...
Scheme
{
	...
	BaseSettings
	{
		...
		Border.Selection				"bluee"			// the additional border color for displaying the default/selected button

		Button.TextColor				"White"
		Button.BgColor					"25 25 25 255"
		Button.ArmedTextColor			"White"
		Button.ArmedBgColor				"2 160 217 50"
		Button.DepressedTextColor		"White"
		Button.DepressedBgColor			"2 160 217 128"
		...
		ComboBoxButton.ArrowColor		"2 160 217 128"
		ComboBoxButton.ArmedArrowColor	"bluee"
		...
		Label.SelectedTextColor			"bluee" //"White" //The section you have currently selected
		...
		ListPanel.SelectedBgColor			"bluee"
		ListPanel.SelectedOutOfFocusBgColor	"2 160 217 128"
		ListPanel.EmptyListInfoTextColor	"150 150 150 255"

		Menu.TextColor					"White"
		Menu.BgColor					"0 0 0 120"
		Menu.ArmedTextColor				"Black"
		Menu.ArmedBgColor				"2 160 217 255"
		Menu.TextInset					"6"

		Panel.FgColor					"DullWhite"
		Panel.BgColor					"Blank"

		ProgressBar.FgColor				"2 160 217 128"
		...
		RichText.SelectedBgColor		"bluee"

		ScrollBar.Wide					"17"

		ScrollBarButton.FgColor				"2 160 217 128"
		ScrollBarButton.BgColor				"Blank"
		ScrollBarButton.ArmedFgColor		"bluee"
		ScrollBarButton.ArmedBgColor		"Blank"
		ScrollBarButton.DepressedFgColor	"bluee"
		ScrollBarButton.DepressedBgColor	"TransparentBlack"

		ScrollBarSlider.FgColor				"2 160 217 32"
		...
		SectionedListPanel.SelectedBgColor				"bluee"
		SectionedListPanel.OutOfFocusSelectedTextColor	"Black"
		SectionedListPanel.OutOfFocusSelectedBgColor	"DarkBlue"

		Slider.NobColor				"2 160 217 128"
		...
		TextEntry.CursorColor		"bluee"
		TextEntry.DisabledTextColor	"DullWhite"
		TextEntry.DisabledBgColor	"Blank"
		TextEntry.SelectedTextColor	"Black"
		TextEntry.SelectedBgColor	"bluee"
	...
	Borders
	{
		...
		FrameBorder
		{
			...
			Left
			{
				...
				"2"
				{
					"color" "2 160 217 50" //"Border.Dark"
					"offset" "1 1"
				}
			}
		...
		TabActiveBorder
		{
			...
			Left
			{
				...
				"2"
				{
					"color" "2 160 217 100" //"Border.Bright"
					"offset" "1 1"
				}
			}
